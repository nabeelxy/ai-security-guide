...
| --- | --- | --- | --- | --- | --- | --- | --- |
| Oct 2025 | | POISONING ATTACKS ON LLMS REQUIRE A NEAR-CONSTANT NUMBER OF POISON SAMPLES| arXiv, Anthropic | [Paper](https://arxiv.org/pdf/2510.07192) | poisoning, fixed-poisoned-dataset, gibberish-text | | |
