...
| Mar 2025 | RuleGenie: SIEM Detection Rule Set Optimization | arXiv | [Paper](https://arxiv.org/pdf/2505.06701v1) | Splunk, Sigma, AQL | | |
...
| Oct 2024 | CTINexus: Automatic Cyber Threat Intelligence Knowledge Graph Construction Using Large Language Models | arXiv, Berkeley | [Paper](https://arxiv.org/pdf/2410.21060) [NotebookLM](https://notebooklm.google.com/notebook/3eb892f8-8636-403f-95d5-844028aa40f0?authuser=1)| knowledge graph, LLM | | |
...
| Jul 2024 | LLMCloudHunter: Harnessing LLMs for Automated Extraction of Detection Rules from Cloud-Based CTI | arXiv | [Paper](https://arxiv.org/pdf/2407.05194) | llm, sigma rules, automate | | |
...
| 2024  | Generative Pre-Trained Transformer-Based Reinforcement Learning for Testing Web Application Firewalls | IEEE TDSC | [Paper](https://ieeexplore.ieee.org/document/10059237) [NotebookLM](https://notebooklm.google.com/notebook/9d5c8258-f491-4de7-a0cd-2fb5a168999e?authuser=1)| fuzzing, web security, vulnerability testing, pentesting, llm, rl | [Github](https://github.com/hongliangliang/gptfuzzer)| |  
...
## Repos
* [PEAK-Assistant](https://github.com/cisco-foundation-ai/PEAK-Assistant) - Threat hunting assistant aligned with the PEAK Framework by Cisco (Made public in Jan 2026)
